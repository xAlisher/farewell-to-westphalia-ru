...
[^1]: Ulysses Pinheiro, 'Leibniz on the Concepts of Archive, Memory, and Sovereignty', *Für Unser Glück Oder Das Glück Anderer*, 3 (2016), 309–21.

[^2]: Gianluca Bottazzi, 'Varsi E La Tabula Alimentaria Di Veleia', *ValcenoStoria*, 2020.

[^3]: Здесь мы оставляем в стороне вопрос о благородстве программы Траяна, которая, вероятно, была мотивирована скорее опасениями по поводу депопуляции сельских регионов империи.

[^4]: Строго говоря, табличка не была абсолютно неизменяемой. Разумеется, можно вносить изменения в бронзовые таблички, и это действительно делалось. Tabula обновлялась на протяжении всего периода своего использования до утраты.

[^5]: Encyclopedia Britannica, 'Cuneiform Law', *Britannica*.

[^6]: Joy Lynn Cole McMillon, 'Law Students Leave Lasting Mark on Uganda's Court System', 2008.
...
[^14]: Peter Ludlow, 'Aaron Swartz Was Right', *The Chronicle of Higher Education*, 2013.

[^15]: Derrida, *Archive Fever*.

[^16]: Pinheiro, 'Leibniz on the Concepts of Archive, Memory, and Sovereignty', 309–21.

[^17]: Достоверность утверждений сына Эскобара — отдельный вопрос. Важно то, что централизованное хранилище записей создаёт точку уязвимости.

[^18]: Боуден — журналист, более известный как автор книги *Blackhawk Down*.
...
[^21]: Криптографический хэш можно представить как электронную подпись, верифицирующую целостность файла (в данном случае — реестра). Если хотя бы один элемент файла изменён, корректный хэш (подпись) не будет получен. Таким образом, подпись служит доказательством того, что реестр не был фальсифицирован.

[^22]: Компьютеры, выполняющие хэширование, также называются «майнерами».

[^23]: Jon Huang, Claire O'Neill and Hiroko Tabuchi, 'Bitcoin Uses More Electricity Than Many Countries: How Is That Possible?', *New York Times*, 9 March 2021.

[^24]: Для многих возобновляемых источников энергии, таких как ветер, значительная часть произведённой энергии пропадает впустую, но энергия, произведённая в непиковые часы, может быть использована для майнинга Bitcoin, радикально повышая рентабельность возобновляемых источников.
